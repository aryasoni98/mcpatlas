...
#[command(
    name = "mcp-atlas",
    about = "MCP Server for the CNCF Landscape (MCPAtlas)"
)]
pub struct AppConfig {
    ...
    /// Directory for caching landscape data (default: ~/.cache/mcp-atlas).
    #[arg(long, env = "MCP_ATLAS_CACHE_DIR")]
    ...
    #[arg(long, env = "MCP_ATLAS_QDRANT_URL")]
