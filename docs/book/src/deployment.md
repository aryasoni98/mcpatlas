...
A Helm chart is provided under `deploy/helm/cncf-mcp/`. Key values:
...
See `deploy/helm/cncf-mcp/values.yaml` and the repository root [MCP_BLUEPRINT.md](https://github.com/cncf-mcp/server/blob/main/MCP_BLUEPRINT.md) for full options.
